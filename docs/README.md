...
<h1 align="center">attack on titan re</h1>
...
Si vous téléchargez à partir des Releases, sélectionnez le programme d'installation de votre système.
 ...
 Plateforme | Fichier |
| -------- | ---- |
| Windows x64 | `Attack-On-Titan-RE-win-x64.exe ` |
| macOS | `Attack-On-Titan-RE-mac-universal.dmg` |
| Linux x64 | `Attack-On-Titan-RE-linux-x86_64.AppImage` |
